...
import { DocumentNotFoundError, BadRequestError, ConflictError } from '../errors/Errors.js'
import { z } from 'zod'
import { stripUndefinedFields } from '../../utils/generalUtils.js'

// Useful Types
import { type DocSnapType, type DbDocData, type Parsed, type ParsedPartial, type Infer, type DbDocType } from './base.types.js'
import { formatDbSnap, isFirestoreError, parseObjectPartial, parseSchema } from '../../utils/utils.js'
...
export default class FirebaseCollectionModel<T extends z.ZodObject, B extends string> {
    constructor(
    ...
    protected txUpdate(tx: admin.firestore.Transaction, doc: DocSnapType, data: ParsedPartial<T, B>) {
