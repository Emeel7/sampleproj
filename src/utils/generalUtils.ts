...
export const stripUndefinedFields = <T extends Record<string, unknown>>(
  o: T,
) => {
...
export const throwNonObjects = (o: unknown): Record<string, any> | never => {
  if (typeof o !== "object" || o === null || Array.isArray(o)) {
    throw new BadRequestError(
      `Expected body to be object, received: ${typeof o}`,
    );
  }
  return o;
};
...
// Actual Utils
export const parseString = <K extends string>(
  id: string | string[] | undefined,
  brand: K,
): Brand<string, K> | never => {
  if (Array.isArray(id)) {
